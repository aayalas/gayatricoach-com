            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-8">
                ...
                <div>
                    {/* <h4 className="text-white font-bold text-lg mb-6">Services</h4> */}
                        <ul className="space-y-4">
                            <li>
                                <a href="" className="hover:text-white text-gray-200 text-[15px]">Therapy</a>
                            </li>
                            <li>
                                <a href="" className="hover:text-white text-gray-200 text-[15px]">Gestalt</a>
                            </li>
                            <li>
                                <a href="" className="hover:text-white text-gray-200 text-[15px]">Constellations</a>
                            </li>
                            <li>
                                <a href="" className="hover:text-white text-gray-200 text-[15px]">Coaching</a>
                            </li>
                        </ul>
                </div>
                <div>
                    ...
                    <ul className="space-y-4">
                        <li>
                            <a href="" className="hover:text-white text-gray-200 text-[15px]">Rinnova Groups</a>
                        </li>
                        <li>
                            <a href="" className="hover:text-white text-gray-200 text-[15px]">Integration Services</a>
                        </li>
                        <li>
                ...
                <div>
                    ...
                    <ul className="space-y-4">
                        <li>
                            <a href="" className="hover:text-white text-gray-200 text-[15px]">About</a>
                        </li>
                        <li>
                            <a href="" className="hover:text-white text-gray-200 text-[15px]">FAQ's</a>
                        </li>
                        <li>
                            <a href="" className="hover:text-white text-gray-200 text-[15px]">Testimonies</a>
                        </li>
                        <li>
                            <a href="" className="hover:text-white text-gray-200 text-[15px]">Terms</a>
                        </li>
                        <li>
                            <a href="" className="hover:text-white text-gray-200 text-[15px]">Policies</a>
                        </li>                        
                    </ul>
                </div>
            </div>
